...
A full-featured lucky draw system built with Next.js, Prisma, and PostgreSQL. This application allows administrators to add entrants, run weighted random draws, and maintain a complete history of all draws and winners.
...
```env
DATABASE_URL="postgresql://postgres:postgres@localhost:5432/gentuna_db?schema=public"
...
3. Set a strong `DRAW_API_KEY`
4. Run migrations: `npm run db:push` or `npm run db:migrate`
